...
print ("\n\033[1mA.\033[0m \033[4mGreater than 15 characters\033[0m")
...
#Variables for initial numbers:
    ...
    digit = 0
    specialchar = 0 
    characters = len (passwordA) #to find the total characters
...
#Step 3: Conditions for the password to be valid
         #a              #b                #c             #d
    if characters >15 and uppercase >=1 and digit >=1 and specialchar >=1:
        print ("\nYour password is \033[32mVALID\033[0m\n")
    elif characters <=15 and uppercase >=1 and digit >=1 and specialchar >=1:
        print ("\nYour password is \033[91mINVALID.\033[0m Make sure that it has more than 15 characters.\n")
    elif characters >15 and uppercase == 0 and digit >=1 and specialchar >=1:
        print ("\nYour password is \033[91mINVALID.\033[0m Make sure that it has at least one capital letter.\n")
    elif characters >15 and uppercase >=1 and digit == 0 and specialchar >=1:
        print ("\nYour password is \033[91mINVALID.\033[0m Make sure that it has at least one number.\n")
    elif characters >15 and uppercase >=1 and digit >=1 and specialchar == 0:
